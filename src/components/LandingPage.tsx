    ...
    <div id="landing-page" className="relative min-h-[calc(100vh-73px)] w-full flex flex-col justify-between overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center flex-1">
        ...
        >
          ...
          <motion.h1 
            variants={itemVariants}
            className="font-display font-bold text-4xl sm:text-5xl lg:text-6xl text-slate-900 leading-[1.1] tracking-tight"
          >
            Master Your Next <br />
          ...
          <motion.p 
            variants={itemVariants}
            className="text-slate-600 text-base sm:text-lg max-w-xl font-normal leading-relaxed"
          >
          ...
          >
            ...
            <a
              href="#how-it-works"
              className="px-8 py-4 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 font-medium text-center transition-colors duration-200 border border-slate-200"
            >
              See How It Works
            </a>
          </motion.div>
          ...
          <motion.div 
            variants={itemVariants}
            className="grid grid-cols-3 gap-6 pt-6 border-t border-slate-200 text-left"
          >
            <div>
              <div className="font-display font-bold text-2xl text-slate-900">100%</div>
              <div className="text-xs text-slate-500 font-mono">Tailored Questions</div>
            </div>
            <div>
              <div className="font-display font-bold text-2xl text-slate-900">Live</div>
              <div className="text-xs text-slate-500 font-mono">Voice & Video API</div>
            </div>
            <div>
              <div className="font-display font-bold text-2xl text-slate-900">Zero</div>
              <div className="text-xs text-slate-500 font-mono">Bias Analysis</div>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          <div className="relative w-full h-[380px] sm:h-[450px] rounded-2xl bg-brand-card/80 border border-slate-200 p-6 flex flex-col justify-between shadow-2xl glass-panel">
            ...
            <div className="space-y-4">
              ...
              <h3 className="text-slate-800 font-display font-medium text-base leading-snug">
              ...
              <div className="flex items-center justify-between space-x-1.5 h-6 bg-brand-bg/50 px-4 py-1.5 rounded-lg border border-slate-200">
                <span className="text-[9px] font-mono text-slate-500">USER INPUT (MIC)</span>
      ...
      <section id="how-it-works" className="max-w-7xl mx-auto px-6 py-16 border-t border-slate-200 w-full text-center">
        <div className="max-w-3xl mx-auto space-y-4 mb-16">
          <h2 className="font-display font-bold text-2xl sm:text-3xl text-slate-900">How Coach Works</h2>
          <p className="text-slate-600">Our evaluation pipeline is highly objective and focuses strictly on evidence, communication flow, and technical capability.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          {/* Card 1 */}
          <div className="p-6 rounded-2xl bg-brand-card border border-slate-200 hover:border-brand-primary/20 transition-all duration-300">
            <div className="w-12 h-12 rounded-xl bg-brand-primary/10 flex items-center justify-center mb-6">
              <FileText className="w-6 h-6 text-brand-primary" />
            </div>
            <h4 className="text-slate-900 font-display font-semibold text-lg mb-3">Portfolio Alignment</h4>
          ...
          <div className="p-6 rounded-2xl bg-brand-card border border-slate-200 hover:border-brand-primary/20 transition-all duration-300">
            ...
            <h4 className="text-slate-900 font-display font-semibold text-lg mb-3">Live Adaptive Questions</h4>
            <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-brand-card border border-slate-200 hover:border-brand-primary/20 transition-all duration-300">
            ...
            <h4 className="text-slate-900 font-display font-semibold text-lg mb-3">Observable Metrics ONLY</h4>
            <p className="text-slate-600 text-sm leading-relaxed">
      ...
      <footer className="w-full border-t border-slate-200 py-8 text-center text-xs text-slate-500 font-mono">
